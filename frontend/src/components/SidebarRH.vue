  ...
  <aside class="w-64 bg-inst-primario text-white flex flex-col min-h-screen">
   ...
   <nav class="flex-1 p-4 space-y-2">
      <button @click="emit('cambiar-vista', 'reporte')"
        ...
        <i class="fa-solid fa-file-invoice w-6 flex-shrink-0 text-center mr-3 text-lg"></i>
      ...
      <button @click="emit('cambiar-vista', 'historial')"
        ...
        <i class="fa-solid fa-folder-open w-6 flex-shrink-0 text-center mr-3 text-lg"></i>
        <span class="text-left leading-tight">Historial Quincenal</span>
      </button>
